...
var segmentsForAnalysis []struct{ Index int; Text string }
for _, seg := range segments {
segmentsForAnalysis = append(segmentsForAnalysis, struct{ Index int; Text string }{seg.Index, seg.OriginalText})
}
